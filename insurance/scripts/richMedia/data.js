			...
			[	
			 	{
					...
					[
						{
							"embed": "<div id='am_page_wrapper' style='position:absolute'><canvas id='demoCanvas'></canvas></div><div id='admaxim_form'><div id='admaxim_form_content'></div><div id='admaxim_thank_you'><div id='admaxim_terms_btn'></div></div></div>"
						} 
					],
					"javascripts" :
					[
